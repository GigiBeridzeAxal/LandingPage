...
function SignupWithOTP() {
  ...
  const handleSubmit = async (e) => {
    ...
    setError('');
    try {
      const response = await axios.post(`${BASE_URL}/api/auth/signup/v2`, {
        name,
        email,
        phoneNumber,
        otp,
  ...
  const handleLoginSubmit = async (e) => {
    ...
    setError('');
    try {
      const response = await axios.post(`${BASE_URL}/api/auth/signin/v2`, {
        phoneNumber,
        otp,
      });
      console.log('Signup success:', response.data);
        ...
        {action === 'login' && (
          <>
            <div className="sm:mx-auto sm:w-full sm:max-w-sm">
              <img
                className="mx-auto h-32 w-auto bg-gray-800 p-4 rounded-2xl"
                src="/logo_1.png"
                alt="Super5"
              />
            ...
            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                ...
                <div>
                  ...
                  {isOtpSent && (
                    <div>
                      <label
                        htmlFor="otp"
                        className="mt-4 text-left block text-sm font-medium leading-6 text-gray-900"
                      >
                        OTP
                      </label>
                      <div className="mt-2">
              ...
              {error && (
                <div className="mt-4 text-red-500 p-2 rounded text-center">
                  {error}
                </div>
              )}
