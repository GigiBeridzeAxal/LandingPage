    ...
    <>
      ...
      <div className="signin__container">
        ...
        {userData.username.length > 0 && (
          <div className="text-xl my-2">Coins : {userData.coins}</div>
        )}
        <div className="subheading">{localStorage.getItem('user_email')}</div>
        <button
          class="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 border-b-4 border-red-700 rounded"
      ...
      <div>
        {coinHistory.length > 0 && (
          <>
            <div className="text-center text-2xl text-gray-600 mt-16 font-bold">
              Coin History
            </div>
                    ...
                    coinHistory.map((data, index) => (
                      <tr key={data.rank}>
                        ...
                        <td className="border p-2">
                          {showTimeInAgoFormat(data.createdAt)}
                        </td>
                        {data.type === 'join' && (
