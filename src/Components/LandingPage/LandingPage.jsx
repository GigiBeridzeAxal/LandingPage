...
export default function LandingPage() {
  ...
  return (
    ...
    <div className="landingpageheaderr flex bg-black w-[100%] flex items-center justify-center p-[10px]">



      <div className="landingpageheader flex items-center  justify-between w-[80%]">
        <div className="left"><img width={120} height={30} src="Super5 logo.png" alt="" /></div>
